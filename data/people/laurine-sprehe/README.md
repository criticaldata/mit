...
_PhD Student · collaborator · MGH/HMS_

## Projects

| Project | Role | Status |
|---|---|---|
| [6 Tools Framework + Jan 15 Event Take-aways](../../projects/6-tools-framework-jan-15-event-take-aways/project.yaml) | Lead | active |
